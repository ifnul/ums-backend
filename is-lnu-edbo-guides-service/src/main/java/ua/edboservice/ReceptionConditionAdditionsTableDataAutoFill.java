 ...
 *         &lt;element name="DodatokNumner" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "ReceptionConditionAdditionsTableDataAutoFill")
public class ReceptionConditionAdditionsTableDataAutoFill {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "DodatokNumner")
    protected int dodatokNumner;
    ...
    /**
     * Gets the value of the dodatokNumner property.
     * 
     */
    public int getDodatokNumner() {
        return dodatokNumner;
    }

    /**
     * Sets the value of the dodatokNumner property.
     * 
     */
    public void setDodatokNumner(int value) {
        this.dodatokNumner = value;
    }
