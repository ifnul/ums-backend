...
public class PersonContactConverter extends AbstractConverter<PersonContact, PersonContactResource> {

	@Override
	public PersonContactResource convert(final PersonContact source, final PersonContactResource target) {
