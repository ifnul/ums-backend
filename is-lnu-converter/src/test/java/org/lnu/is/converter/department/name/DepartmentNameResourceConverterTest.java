...
public class DepartmentNameResourceConverterTest {
	...
	public void testConvertAll() throws Exception {
		...
		DepartmentName expected1 = new DepartmentName();
		DepartmentNameResource source1 = new DepartmentNameResource();

		List<DepartmentName> expecteds = Arrays.asList(expected,expected1);
		
		List<DepartmentNameResource> sources = Arrays.asList(source, source1);
		// When
		List<DepartmentName> actual = unit.convertAll(sources);
