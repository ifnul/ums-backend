...
public class SpecOfferWaveParametersExtractorTest {
	...
	@InjectMocks
	private SpecOfferWaveParametersExtractor unit;
	...
	public void testGetParameters() throws Exception {
		...
		expected.put("waveType", waveType);
		expected.put("licCount", licCount);
		...
		when(waveTypeDao.getEntityById(anyLong())).thenReturn(waveType);
