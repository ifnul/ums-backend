...
import org.lnu.is.extractor.married.type.MarriedTypeParametersExtractor;
...
public class MarriedTypeParametersExtractorTest {
	...
	@Test
	public void testGetParametersWithDi() throws Exception {
		// Given
	...
	@Test
	public void testGetParametersWithDefaultEntityWithDisbledStatus() throws Exception {
		// Given
		unit.setActive(false);
