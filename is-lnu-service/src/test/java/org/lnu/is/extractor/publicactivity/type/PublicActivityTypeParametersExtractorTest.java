...
public class PublicActivityTypeParametersExtractorTest {

	@Mock
	private SessionService sessionService;
	
	@InjectMocks
	private PublicActivityTypeParametersExtractor unit;
	...
	public void testGetParameters() throws Exception {
		// Given
		PublicActivityType entity = new PublicActivityType();
