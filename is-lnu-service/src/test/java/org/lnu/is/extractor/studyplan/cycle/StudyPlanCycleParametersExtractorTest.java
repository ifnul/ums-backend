...
public class StudyPlanCycleParametersExtractorTest {

	@InjectMocks
	private StudyPlanCycleParametersExtractor unit;
	...
	public void testGetParameters() throws Exception {
		// Given
		StudyPlanCycle entity = new StudyPlanCycle();
	...
	@Test
	public void testGetParametersWithDefaultEntityAndDissabledSecurity() throws Exception {
		// Given
		unit.setSecurity(false);
