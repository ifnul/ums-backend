 ...
 *         &lt;element name="UniversityOrderRequestsCategoriesRegisterDate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "", propOrder = {
    ...
    "universityOrderRequestsCategoriesRegisterDate"
})
@XmlRootElement(name = "UniversityOrderRequestsRegister")
public class UniversityOrderRequestsRegister {
    ...
    @XmlElement(name = "UniversityOrderRequestsCategoriesRegisterDate")
    protected String universityOrderRequestsCategoriesRegisterDate;
    ...
    /**
     * Gets the value of the universityOrderRequestsCategoriesRegisterDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getUniversityOrderRequestsCategoriesRegisterDate() {
        return universityOrderRequestsCategoriesRegisterDate;
    }

    /**
     * Sets the value of the universityOrderRequestsCategoriesRegisterDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setUniversityOrderRequestsCategoriesRegisterDate(String value) {
        this.universityOrderRequestsCategoriesRegisterDate = value;
    }
