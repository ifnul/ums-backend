 ...
 *         &lt;element name="AddToEDBO" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "WebPersonStatementImport")
public class WebPersonStatementImport {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "UniversityKode")
    protected String universityKode;
    @XmlElement(name = "AddToEDBO")
    protected int addToEDBO;
    ...
    /**
     * Gets the value of the addToEDBO property.
     * 
     */
    public int getAddToEDBO() {
        return addToEDBO;
    }

    /**
     * Sets the value of the addToEDBO property.
     * 
     */
    public void setAddToEDBO(int value) {
        this.addToEDBO = value;
    }
