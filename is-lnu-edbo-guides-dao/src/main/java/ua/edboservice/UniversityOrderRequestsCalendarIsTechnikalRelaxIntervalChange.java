...
@XmlRootElement(name = "UniversityOrderRequestsCalendarIsTechnikalRelaxIntervalChange")
public class UniversityOrderRequestsCalendarIsTechnikalRelaxIntervalChange {
