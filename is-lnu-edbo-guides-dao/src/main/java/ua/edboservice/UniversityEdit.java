 ...
 *         &lt;element name="UniverityChildFacultetNumberKode" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlType(name = "", propOrder = {
    ...
    "univerityChildFacultetNumberKode",
...
@XmlRootElement(name = "UniversityEdit")
public class UniversityEdit {
    ...
    @XmlElement(name = "UniverityChildFacultetNumberKode")
    protected int univerityChildFacultetNumberKode;
    ...
    /**
     * Gets the value of the univerityChildFacultetNumberKode property.
     * 
     */
    public int getUniverityChildFacultetNumberKode() {
        return univerityChildFacultetNumberKode;
    }

    /**
     * Sets the value of the univerityChildFacultetNumberKode property.
     * 
     */
    public void setUniverityChildFacultetNumberKode(int value) {
        this.univerityChildFacultetNumberKode = value;
    }
