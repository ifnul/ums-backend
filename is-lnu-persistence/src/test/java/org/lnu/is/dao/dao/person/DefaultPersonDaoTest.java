...
public class DefaultPersonDaoTest {
	...
	public void testGetPersons() throws Exception {
		...
		Queries<Person> query = new Queries<Person>(Person.class, querySql);
		PagedQuerySearch<Person> pagedSearch = new PagedQuerySearch<Person>(query, offset, limit, Collections.<String, Object> emptyMap(), Person.class);
		...
		// When
		when(queryBuilder.build(any(Person.class))).thenReturn(querySql);
		when(persistenceManager.search(Matchers.<PagedQuerySearch<Person>>any())).thenReturn(expected);
