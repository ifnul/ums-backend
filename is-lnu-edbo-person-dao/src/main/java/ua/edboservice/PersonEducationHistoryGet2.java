 ...
 *         &lt;element name="IsActiveOnly" type="{http://www.w3.org/2001/XMLSchema}int"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "PersonEducationHistoryGet2")
public class PersonEducationHistoryGet2 {
    ...
    @XmlElement(name = "IsActiveOnly")
    protected int isActiveOnly;
    ...
    /**
     * Gets the value of the isActiveOnly property.
     * 
     */
    public int getIsActiveOnly() {
        return isActiveOnly;
    }

    /**
     * Sets the value of the isActiveOnly property.
     * 
     */
    public void setIsActiveOnly(int value) {
        this.isActiveOnly = value;
    }
