 ...
 *         &lt;element name="PersonEducationCancelDate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "PersonEducationsStatusChangeCancelEducation")
public class PersonEducationsStatusChangeCancelEducation {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "UniversityKode")
    protected String universityKode;
    @XmlElement(name = "PersonEducationCancelDate")
    protected String personEducationCancelDate;
    ...
    /**
     * Gets the value of the personEducationCancelDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPersonEducationCancelDate() {
        return personEducationCancelDate;
    }

    /**
     * Sets the value of the personEducationCancelDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPersonEducationCancelDate(String value) {
        this.personEducationCancelDate = value;
    }
