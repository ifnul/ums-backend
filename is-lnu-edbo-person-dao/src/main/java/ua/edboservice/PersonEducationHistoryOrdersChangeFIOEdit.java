 ...
 *         &lt;element name="FIODateChange" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "PersonEducationHistoryOrdersChangeFIOEdit")
public class PersonEducationHistoryOrdersChangeFIOEdit {
    ...
    @XmlElement(name = "FIODateChange")
    protected String fioDateChange;
     ...
     *     
     */
    public String getFIODateChange() {
     ...
     *     
     */
    public void setFIODateChange(String value) {
