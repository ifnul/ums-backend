 ...
 *         &lt;element name="Id_PersonHomeAddress" type="{http://www.w3.org/2001/XMLSchema}int"/>
...
@XmlRootElement(name = "PersonAddressesEdit2")
public class PersonAddressesEdit2 {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "Id_PersonHomeAddress")
    protected int idPersonHomeAddress;
    ...
    /**
     * Gets the value of the idPersonHomeAddress property.
     * 
     */
    public int getIdPersonHomeAddress() {
        return idPersonHomeAddress;
    }

    /**
     * Sets the value of the idPersonHomeAddress property.
     * 
     */
    public void setIdPersonHomeAddress(int value) {
        this.idPersonHomeAddress = value;
    }
