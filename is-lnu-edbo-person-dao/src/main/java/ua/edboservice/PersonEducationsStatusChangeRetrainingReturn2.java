 ...
 *         &lt;element name="PersonEducationRetrainingDate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "PersonEducationsStatusChangeRetrainingReturn2")
public class PersonEducationsStatusChangeRetrainingReturn2 {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "UniversityKode")
    protected String universityKode;
    @XmlElement(name = "PersonEducationRetrainingDate")
    protected String personEducationRetrainingDate;
    ...
    /**
     * Gets the value of the personEducationRetrainingDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPersonEducationRetrainingDate() {
        return personEducationRetrainingDate;
    }

    /**
     * Sets the value of the personEducationRetrainingDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPersonEducationRetrainingDate(String value) {
        this.personEducationRetrainingDate = value;
    }
