package org.lnu.is.domain.enrolmentenrolsubject;
...
import org.lnu.is.domain.personenrolmentsubject.PersonEnrolmentSubject;
...
public class EnrolmentEnrolSubject extends Model {
	...
	public boolean equals(final Object obj) {
		...
		EnrolmentEnrolSubject other = (EnrolmentEnrolSubject) obj;
		if (mark == null) {
			if (other.mark != null) {
				return false;
			}
