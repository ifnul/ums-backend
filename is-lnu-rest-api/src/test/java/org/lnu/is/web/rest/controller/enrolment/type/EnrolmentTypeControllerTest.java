...
public class EnrolmentTypeControllerTest extends AbstractControllerTest {
    @Mock
    private Facade<EnrolmentTypeResource, EnrolmentTypeResource, Long> facade;
    ...
    public void testGetEnrolmentTypes() throws Exception {
        ...
        PagedRequest<EnrolmentTypeResource> pagedRequest = new PagedRequest<EnrolmentTypeResource>(new EnrolmentTypeResource(), offset, limit, Collections.<OrderBy>emptyList(), params);
