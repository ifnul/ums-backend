...
public class PersonAwardControllerTest extends AbstractControllerTest {
	...
	@Mock
	private Facade<PersonAwardResource, PersonAwardResource, Long> facade;
	...
	public void testGetPersonAwards() throws Exception {
		...
		PagedRequest<PersonAwardResource> pagedRequest = new PagedRequest<PersonAwardResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
