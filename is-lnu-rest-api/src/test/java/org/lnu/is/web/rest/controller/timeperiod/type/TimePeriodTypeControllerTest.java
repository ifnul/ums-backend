...
public class TimePeriodTypeControllerTest extends AbstractControllerTest {
    ...
    public void testGetTimePeriodTypes() throws Exception {
        ...
        List<TimePeriodTypeResource> entities = Collections.singletonList(resource);
        ...
        PagedRequest<TimePeriodTypeResource> request = new PagedRequest<TimePeriodTypeResource>(paramResource, offset, limit, Collections.<OrderBy>emptyList(), params);
