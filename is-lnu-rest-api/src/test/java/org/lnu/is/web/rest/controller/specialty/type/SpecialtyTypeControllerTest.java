...
public class SpecialtyTypeControllerTest extends AbstractControllerTest {
	...
	@Mock
	private Facade<SpecialtyTypeResource, SpecialtyTypeResource, Long> facade;
	...
	public void testGetSpecialtyTypes() throws Exception {
		...
		PagedRequest<SpecialtyTypeResource> request = new PagedRequest<SpecialtyTypeResource>(paramResource, offset, limit, Collections.<OrderBy>emptyList(), params);
