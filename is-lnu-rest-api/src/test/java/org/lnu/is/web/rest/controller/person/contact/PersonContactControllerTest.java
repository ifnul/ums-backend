...
public class PersonContactControllerTest extends AbstractControllerTest {
    ...
    @Mock
    private Facade<PersonContactResource, PersonContactResource, Long> facade;
    ...
    public void testGetPersonPapers() throws Exception {
		...
		PagedRequest<PersonContactResource> pagedRequest = new PagedRequest<PersonContactResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
