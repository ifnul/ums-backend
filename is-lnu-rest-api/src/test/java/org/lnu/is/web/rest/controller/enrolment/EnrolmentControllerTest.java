...
public class EnrolmentControllerTest extends AbstractControllerTest {
    ...
    public void testGetEnrolments() throws Exception {
        ...
        PagedRequest<EnrolmentResource> pagedRequest = new PagedRequest<EnrolmentResource>(new EnrolmentResource(), offset, limit, Collections.<OrderBy>emptyList(), params);
