...
public class PersonEducationControllerTest extends AbstractControllerTest {
    ...
    @Mock
    private Facade<PersonEducationResource, PersonEducationResource, Long> facade;
    ...
    public void testGetPersonPapers() throws Exception {
		...
		PagedRequest<PersonEducationResource> pagedRequest = new PagedRequest<PersonEducationResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
