...
public class SpecOfferControllerTest extends AbstractControllerTest {
	...
	public void testGetSpecOffers() throws Exception {
		...
		PagedRequest<SpecOfferResource> pagedRequest = new PagedRequest<SpecOfferResource>(new SpecOfferResource(), offset, limit, Collections.<OrderBy>emptyList(), params);
