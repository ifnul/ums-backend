...
public class EnrolmentStatusTypeControllerTest extends AbstractControllerTest {
	...
	@Mock
	private Facade<EnrolmentStatusTypeResource, EnrolmentStatusTypeResource, Long> facade;
	...
	public void testGetEnrolmentStatusTypes() throws Exception {
		...
		PagedRequest<EnrolmentStatusTypeResource> request = new PagedRequest<EnrolmentStatusTypeResource>(paramResource, offset, limit, Collections.<OrderBy>emptyList(), params);
