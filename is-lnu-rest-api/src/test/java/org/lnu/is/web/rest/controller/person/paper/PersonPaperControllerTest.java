...
public class PersonPaperControllerTest extends AbstractControllerTest {
	...
	@Mock
	private Facade<PersonPaperResource, PersonPaperResource, Long> facade;
	...
	public void testGetPersonPapers() throws Exception {
		...
		PagedRequest<PersonPaperResource> pagedRequest = new PagedRequest<PersonPaperResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
