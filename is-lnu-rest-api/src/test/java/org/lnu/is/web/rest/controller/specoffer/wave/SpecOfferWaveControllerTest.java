...
public class SpecOfferWaveControllerTest extends AbstractControllerTest {
	...
	List<SpecOfferWaveResource> entities = Arrays
		.asList(specOfferSubjectResource);
	...
	when(
		facade.getResources(Matchers
			.<PagedRequest<SpecOfferWaveResource>> any()))
		.thenReturn(expectedResource);
	String response = getJson(expectedResource, false);

	// Then
	mockMvc.perform(
		get("/specoffers/{0}/waves", specOfferId).param("offset",
