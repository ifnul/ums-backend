...
public class DepartmentAddressControllerTest extends AbstractControllerTest {
    ...
    @Test
    public void testDeleteDepatmentAddress() throws Exception {
        // Given
        Long personId = 2L;
        Long Id = 1L;
        ...
        // Then
        mockMvc.perform(delete("/departments/{departmentId}/addresses/{addressId}", personId, Id))
    ...
    public void testGetDepartmentPapers() throws Exception {
        ...
        PagedRequest<DepartmentAddressResource> pagedRequest = new PagedRequest<DepartmentAddressResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
