...
public class DepartmentSpecialtyControllerTest extends AbstractControllerTest {
	...
	@Mock
	private Facade<DepartmentSpecialtyResource, Long> facade;
	...
	public void testGetDepartmentSpecialties() throws Exception {
		...
		PagedRequest<DepartmentSpecialtyResource> pagedRequest = new PagedRequest<DepartmentSpecialtyResource>(resource, offset, limit);
