...
public class DepartmentSpecialtyControllerTest extends AbstractControllerTest {
	...
	public void testGetDepartmentSpecialties() throws Exception {
		...
		PagedRequest<DepartmentSpecialtyResource> pagedRequest = new PagedRequest<DepartmentSpecialtyResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
