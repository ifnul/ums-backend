...
public class DegreeControllerTest extends AbstractControllerTest {
    ...
    public void testGetDegrees() throws Exception {
        ...
        PagedRequest<DegreeResource> pagedRequest = new PagedRequest<DegreeResource>(new DegreeResource(), offset, limit, Collections.<OrderBy>emptyList(), params);
    ...
    public void testGetPersonDegrees() throws Exception {
        ...
        params.put("offset", String.valueOf(offset));
        params.put("limit", String.valueOf(limit));
        PagedRequest<DegreeResource> pagedRequest = new PagedRequest<DegreeResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
