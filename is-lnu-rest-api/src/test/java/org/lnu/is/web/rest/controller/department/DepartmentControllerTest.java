...
public class DepartmentControllerTest extends AbstractControllerTest {
    ...
    public void testGetDepartments() throws Exception {
        ...
        PagedRequest<DepartmentResource> pagedRequest = new PagedRequest<DepartmentResource>(new DepartmentResource(), offset, limit, Collections.<OrderBy>emptyList(), params);
