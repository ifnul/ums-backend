...
public class DepartmentContactControllerTest extends AbstractControllerTest {
    ...
    public void testGetDepartmentPapers() throws Exception {
        ...
        PagedRequest<DepartmentContactResource> pagedRequest = new PagedRequest<DepartmentContactResource>(resource, offset, limit, Collections.<OrderBy>emptyList(), params);
