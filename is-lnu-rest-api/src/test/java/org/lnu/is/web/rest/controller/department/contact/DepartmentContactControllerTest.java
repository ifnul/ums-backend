...
public class DepartmentContactControllerTest extends AbstractControllerTest {
	...
	@Mock
	private Facade<DepartmentContactResource, Long> facade;
	...
	public void testGetDepartmentPapers() throws Exception {
		...
		PagedRequest<DepartmentContactResource> pagedRequest = new PagedRequest<DepartmentContactResource>(resource, offset, limit);
