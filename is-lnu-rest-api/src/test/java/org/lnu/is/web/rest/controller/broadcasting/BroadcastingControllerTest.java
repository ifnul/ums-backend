...
public class BroadcastingControllerTest extends AbstractControllerTest {
    ...
    public void testGetBroadcastingMessages() throws Exception {
        ...
        PagedRequest<BroadcastingMessageResource> pagedRequest = new PagedRequest<BroadcastingMessageResource>(new BroadcastingMessageResource(), offset, limit, Collections.<OrderBy>emptyList(), params);
