 ...
 *         &lt;element name="PersonEducationHistoryDate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "PersonEducationsStatusChangeCorrect")
public class PersonEducationsStatusChangeCorrect {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "UniversityKode")
    protected String universityKode;
    @XmlElement(name = "PersonEducationHistoryDate")
    protected String personEducationHistoryDate;
    ...
    /**
     * Gets the value of the personEducationHistoryDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPersonEducationHistoryDate() {
        return personEducationHistoryDate;
    }

    /**
     * Sets the value of the personEducationHistoryDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPersonEducationHistoryDate(String value) {
        this.personEducationHistoryDate = value;
    }
