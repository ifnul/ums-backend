 ...
 *         &lt;element name="ClientIpAdress" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
public class Login2 {
    ...
    @XmlElement(name = "ClientIpAdress")
    ...
    /**
     * Gets the value of the clientIpAdress property.
     * 
     * @return
     *     possible object is
     *     {@link String }
    ...
    /**
     * Sets the value of the clientIpAdress property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setClientIpAdress(String value) {
        this.clientIpAdress = value;
    }
