 ...
 *         &lt;element name="PersonEducationReCertificateContinueDate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "", propOrder = {
    "sessionGUID",
    "universityKode",
    "personEducationReCertificateContinueDate",
    "idPersonEducationHistoryOrders",
    "personEducationHistoryDesciption",
    "idPersonEducations",
    "idAcademicYear"
})
@XmlRootElement(name = "PersonEducationsStatusChangeReCertificationContinue")
public class PersonEducationsStatusChangeReCertificationContinue {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "UniversityKode")
    protected String universityKode;
    @XmlElement(name = "PersonEducationReCertificateContinueDate")
    protected String personEducationReCertificateContinueDate;
    ...
    /**
     * Gets the value of the personEducationReCertificateContinueDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPersonEducationReCertificateContinueDate() {
        return personEducationReCertificateContinueDate;
    }

    /**
     * Sets the value of the personEducationReCertificateContinueDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPersonEducationReCertificateContinueDate(String value) {
        this.personEducationReCertificateContinueDate = value;
    }
