 ...
 *         &lt;element name="PersonEducationRenewalDate" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlRootElement(name = "PersonEducationsStatusChangeRenewal2")
public class PersonEducationsStatusChangeRenewal2 {

    @XmlElement(name = "SessionGUID")
    protected String sessionGUID;
    @XmlElement(name = "UniversityKode")
    protected String universityKode;
    @XmlElement(name = "PersonEducationRenewalDate")
    protected String personEducationRenewalDate;
    ...
    /**
     * Gets the value of the personEducationRenewalDate property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPersonEducationRenewalDate() {
        return personEducationRenewalDate;
    }

    /**
     * Sets the value of the personEducationRenewalDate property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPersonEducationRenewalDate(String value) {
        this.personEducationRenewalDate = value;
    }
