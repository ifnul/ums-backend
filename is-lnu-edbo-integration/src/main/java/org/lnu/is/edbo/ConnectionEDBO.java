...
class ConnectionEDBO
    {
        ...
        private ConnectionEDBO() throws RemoteException
        {
            ...
            Boolean[] enable = new Boolean[] { false, false, false, true, true, false, false, false, false, false, false, false };
            final int count = 12;
            countGuides = 0;
            countPerson = 0;
...
//
//                allGuides.add(new EDBOGuides("http://"+lc[i].Ip+":"+lc[i].Port+"/EDBOGuides/EDBOGuides.asmx").getEDBOGuidesSoap());
