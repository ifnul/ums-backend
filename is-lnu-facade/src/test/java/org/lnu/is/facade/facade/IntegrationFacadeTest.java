...
public class IntegrationFacadeTest {
	...
	@Mock
	private IntegrationDispatcher<PersonResource> createDispatcher;
	
	@Mock
	private IntegrationDispatcher<PersonResource> updateDispatcher;
	...
	public void testUpdateEntity() throws Exception {
		...
		verify(updateDispatcher).dispatch(expected);
		verify(updateDispatcher).getMethod();
	}
