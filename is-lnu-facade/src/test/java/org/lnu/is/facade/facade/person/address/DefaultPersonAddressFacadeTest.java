...
public class DefaultPersonAddressFacadeTest {
	...
	public void testGetPersonPapers() throws Exception {
		...
		PagedSearch<PersonAddress> pagedSearch = new PagedSearch<PersonAddress>(offset, limit, new Queries(queryName, query), Collections.<String, Object> emptyMap(), PersonAddress.class);
